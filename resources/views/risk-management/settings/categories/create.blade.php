...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h1 class="mb-4">Tambah Kategori Risiko</h1>
        </div>
    </div>
        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Formulir Tambah Kategori Risiko</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('risk-management.settings.categories.store') }}" method="POST">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            <a href="{{ route('risk-management.settings.categories.list') }}" class="btn btn-secondary me-2">
