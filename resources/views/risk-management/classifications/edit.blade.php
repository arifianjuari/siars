        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4>Edit Klasifikasi & Skoring Risiko</h4>
                    <span class="badge bg-primary">ID Insiden: {{ $classification->incident->id }}</span>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-6">
                    ...
                    <form action="{{ route('risk-management.classifications.update', $classification->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="dampak" id="dampak" class="form-control @error('dampak') is-invalid @enderror" required>
                                        ...
                                        <option value="1" {{ $classification->dampak == 1 ? 'selected' : '' }}>1 - Minimal (Tidak ada cedera)</option>
                                        <option value="2" {{ $classification->dampak == 2 ? 'selected' : '' }}>2 - Minor (Cedera ringan)</option>
                                        <option value="3" {{ $classification->dampak == 3 ? 'selected' : '' }}>3 - Moderate (Cedera sedang)</option>
                                        <option value="4" {{ $classification->dampak == 4 ? 'selected' : '' }}>4 - Major (Cedera berat)</option>
                                        <option value="5" {{ $classification->dampak == 5 ? 'selected' : '' }}>5 - Extreme (Kematian/cacat permanen)</option>
                                    </select>
                                    @error('dampak')
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <textarea name="dampak_detail" id="dampak_detail" rows="3" class="form-control @error('dampak_detail') is-invalid @enderror">{{ old('dampak_detail', $classification->dampak_detail) }}</textarea>
                                    @error('dampak_detail')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="probabilitas" id="probabilitas" class="form-control @error('probabilitas') is-invalid @enderror" required>
                                        ...
                                        <option value="1" {{ $classification->probabilitas == 1 ? 'selected' : '' }}>1 - Sangat Jarang (>5 tahun sekali)</option>
                                        <option value="2" {{ $classification->probabilitas == 2 ? 'selected' : '' }}>2 - Jarang (1-5 tahun sekali)</option>
                                        <option value="3" {{ $classification->probabilitas == 3 ? 'selected' : '' }}>3 - Mungkin (Setahun sekali)</option>
                                        <option value="4" {{ $classification->probabilitas == 4 ? 'selected' : '' }}>4 - Sering (Sebulan sekali)</option>
                                        <option value="5" {{ $classification->probabilitas == 5 ? 'selected' : '' }}>5 - Sangat Sering (Seminggu sekali)</option>
                                    </select>
                                    @error('probabilitas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <textarea name="probabilitas_detail" id="probabilitas_detail" rows="3" class="form-control @error('probabilitas_detail') is-invalid @enderror">{{ old('probabilitas_detail', $classification->probabilitas_detail) }}</textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="skor_risiko" name="skor_risiko" class="form-control" value="{{ $classification->skor_risiko }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Level Risiko</label>
                                                    <input type="text" id="level_risiko" name="level_risiko" class="form-control" value="{{ $classification->level_risiko }}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Zona Risiko</label>
                                                    <input type="text" id="zona_risiko" name="zona_risiko" class="form-control" value="{{ $classification->zona_risiko }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 d-flex justify-content-end">
                                <a href="{{ route('risk-management.incidents.show', $classification->incident_id) }}" class="btn btn-secondary me-2">Batal</a>
...
<script>
    $(document).ready(function() {
        ...
        // Panggil fungsi saat halaman dimuat untuk menginisialisasi nilai
        calculateRisk();
    });
</script>
@endpush
