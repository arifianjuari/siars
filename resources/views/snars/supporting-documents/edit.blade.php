        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('snars.supporting-documents.update', $document->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                                ...
                                <div>
                                    ...
                                    <select id="assessment_element_id" name="assessment_element_id" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                        ...
                                        @foreach ($assessmentElements as $element)
                                            <option value="{{ $element->id }}" {{ (old('assessment_element_id', $document->assessment_element_id) == $element->id) ? 'selected' : '' }}>
                        ...
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 mb-4">File Saat Ini</h3>
                        ...
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Ganti File (Opsional)</h3>
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    <x-label for="document_file" :value="__('File Dokumen Baru')" />
