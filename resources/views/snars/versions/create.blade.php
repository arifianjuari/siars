        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('snars.versions.store') }}" method="POST">
                        @csrf
                        
                        <div class="mb-4">
                            <label for="version_number" class="block text-sm font-medium text-gray-700">Version Number</label>
                            <input type="text" name="version_number" id="version_number" value="{{ old('version_number') }}" 
