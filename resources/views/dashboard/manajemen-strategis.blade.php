<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Dashboard Manajemen Strategis') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mb-6" role="alert">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm">Anda sedang mengakses sebagai Admin RS. <a href="{{ route('superadmin.exit-impersonation') }}" class="font-bold underline">Kembali ke akses Superadmin</a></p>
                    </div>
                </div>
            </div>
            @endif
