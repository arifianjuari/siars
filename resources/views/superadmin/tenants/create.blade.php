        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form action="{{ route('superadmin.tenants.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="website" name="website" type="url" class="mt-1 block w-full" :value="old('website')" autocomplete="website" />
