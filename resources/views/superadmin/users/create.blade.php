                    ...
                    <form method="POST" action="{{ route('superadmin.users.store') }}" class="space-y-6">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                            ...
                            <div class="mt-4 flex items-center">
                                <input id="is_active" type="checkbox" name="is_active" value="1" checked class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800">
