...
class SnarsDocumentType extends Model implements Auditable
{
     ...
     * @var string
     */
    protected $table = 'snars_document_types';
    ...
    {
        return $this->hasMany(SnarsRequiredDocument::class, 'document_type_id');
    }
    ...
    {
        return $this->hasMany(SnarsDocument::class, 'document_type_id');
    }
